...
function UpworkView({ navigation }) {
  ...
  async function refreshJobs() {
    ...
    try {
      const response = await fetch('/api/upwork/jobs/refresh', { method: 'POST' });
      const payload = await response.json();
      ...
      <div className="app-wrap">
        <header className="topbar">
          <div className="brand-lockup">
            ...
            <div><span className="eyebrow">Personal command center</span><strong>Personal Agent</strong></div>
          </div>
          {navigation}
...
window.__personalAgentRoot.render(<App />);
